...
* **Exercícios Práticos:** Resolução de problemas focados nos pilares do pensamento computacional (decomposição, reconhecimento de padrões, abstração e algoritmos).
